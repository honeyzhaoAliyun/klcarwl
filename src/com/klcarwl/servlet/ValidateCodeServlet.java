...
public class ValidateCodeServlet extends HttpServlet {
	...
	public static boolean validate(HttpServletRequest request, String validateCode){
		String code = (String)request.getSession().getAttribute(SESSION_VALIDATE_CODE);
		return validateCode.toUpperCase().equalsIgnoreCase(code); 
	}

	public void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String validateCode = request.getParameter(SESSION_VALIDATE_CODE); // AJAX验证，成功返回true
	...
	private void createImage(HttpServletRequest request,
		...
		session.setAttribute(captchaId, s);
