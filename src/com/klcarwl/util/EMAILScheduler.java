 ...
 * 
 */
public class EMAILScheduler extends Thread{
	
	private static Logger logger = Logger.getLogger(EMAILScheduler.class);
	...
	public EMAILScheduler(String email, String title, String content) {
		this.email = email;
		this.title = title;
	...
	private String getContent(String content){
		...
		sb.append("<tr><td align='left'>亲爱的会员：</td></tr>");
		sb.append(" <tr><td align='left' valign='top' >");
		sb.append(content);
		sb.append("</td></tr>");
		sb.append("<tr><td align='right' style='padding:0 30px 50px 0;''>中斗优油客服提醒</td></tr>");
		sb.append("</table>");
		sb.append("<div class='footer'>版权所有：北京中斗科技股份有限公司</div>");
	...
	public static void main(String[] args) {
		...
		new EMAILScheduler("zfshi@126.com", "ss",sendMsg.toString()).start();
	}
}
