...
function good_delete(obj){
	if(confirm("确定要删除该货源信息吗？")){
		window.location.href="<%=basePath %>goods/good_delete.do?goodId="+obj;
	}
}
    ...
    <div id="wrapbox" > 
	  ...
	  <div class="top"> 
	  	<span class="bt1">
	  		<span class="bt11"><a href="<%=basePath %>index.do"><img src="${ctxStatic}/images/img_jt.png" /></a></span>
	  		<span class="bt22"><a href="<%=basePath %>index.do">回首页</a></span>
  		</span>
  		<span class="btr">货源</span>
  		<span class="bt3">
		      ...
		      <div class="fh_xq">
		        <div class="fh_xq_left">
		        	...
		        	<div class="img_xq" >
			        	...
			        	<br/>
		        		<a href="<%=basePath %>goods/good_edit.do?goodId=${msgContentVo.ID}"><span class="dz"><img src="${ctxStatic}/images/img_bj.png" />【编辑】</span></a>
		        		<a href="javascript:void();"><span class="jb" onclick="good_delete('${msgContentVo.ID}')" ><img src="${ctxStatic}/images/img_sc.png"/> 【删除】</span></a>
			       </div>
		        	<!-- 信息--类型  重量--end -->
