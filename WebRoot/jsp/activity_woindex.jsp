		...
		<div class="warp">
			...
			<div class="top">
				<div class="clock">
					...
					<div class="clock_text"><span id="timeclock">0</span>s</div>
				</div>
				<div class="logo">
				...
				<div class="btn">
					<a href="javascript:void(0);" onclick="gamerules()"><img src="${ctxStatic}/activity/images/btn_1.png" /> </a><a href="${ctx}/_wo.do" target="_self" ><img src="${ctxStatic}/activity/images/btn_3.png" /> </a>
				</div>
			</div>
		</div>
		<div class="content">
